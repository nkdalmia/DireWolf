...
class JobApplicationsControllerTest < ActionController::TestCase
  ...
  test "should create job_application" do
    assert_difference('JobApplication.count') do
      post :create, job_application: { cover_letter: @job_application.cover_letter, job_id: @job_application.job_id, status_id: @job_application.status_id, user_id: @job_application.user_id }
    end
  ...
  test "should update job_application" do
    patch :update, id: @job_application, job_application: { cover_letter: @job_application.cover_letter, job_id: @job_application.job_id, status_id: @job_application.status_id, user_id: @job_application.user_id }
    assert_redirected_to job_application_path(assigns(:job_application))
  end
